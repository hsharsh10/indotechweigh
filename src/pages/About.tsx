          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {achievements.map((item, index) => (
                <ScrollReveal key={item.label} animation="zoom" delay={index * 100}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreValues.map((value, index) => (
              <ScrollReveal key={value.title} animation="slide-up" delay={index * 100}>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {expertise.map((item, index) => (
                    <ScrollReveal key={item} animation="fade" delay={index * 50}>
              ...
              <div className="bg-primary-foreground/10 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/75 font-medium">ISO Standards Compliant</p>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {[
                  ...
                  <ScrollReveal key={item} animation="zoom" delay={idx * 100}>
